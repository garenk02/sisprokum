...
@endif
				...
				{{ Form::select('structure', $structure_options, null, ['id'=>'structure','class'=>'form-control']) }}
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
				{{ Form::select('structural', $structural_options, null, ['id'=>'structural','class'=>'form-control']) }}
				</div>					
			</div>	
			{{ Form::close() }}		
    ...
    var oTable = $(".js-data").DataTable({
        ...
        "ajax": {
			...
			"data": function(data) {
				...
				data.structural = $('#structural').val();				
			},			
        },
        "columns": [
            { "data": "row" },
