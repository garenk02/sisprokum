...
<div class="row">	
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			{{ Form::model($data, ['id'=>'form', 'route'=>!empty($data['option_id']) ? ['options.update', $data['option_id']] : ['options.create', null], 'action'=>'OptionController@save', 'class'=>'form-horizontal form-label-left']) }}
			{{ Form::hidden('option_id', null) }}
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Nama Pilihan <span style="color:red">*</span></label>		
				<div class="col-md-6 col-sm-6 col-xs-12">
				{{ Form::text('option_name', null, ['class'=>'form-control','required'=>true]) }}
				</div>
			</div>			
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Tipe Pilihan</label>		
				<div class="col-md-6 col-sm-6 col-xs-12">
				{{ Form::select('option_type', $type_options, null, ['class'=>'form-control select2_single']) }}
				</div>
			</div>		
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Urutan</label>	
				<div class="col-md-3 col-sm-4 col-xs-12">
				{{ Form::number('option_order', null, ['class'=>'form-control']) }}
				</div>
			</div>			
			<div class="form-group">
