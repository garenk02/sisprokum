...
@if (in_array('create', $profile['user_modules'][$module['module_id']]))				
				<a href="#" id="activate" class="btn btn-danger"><i class="fa fa-random"></i> Aktivasi Pelimpahan</a>
@endif
				</div>
			</div>		  
			...
			<table id="datatable" class="table table-striped table-bordered table-hover js-data dataTable dt-responsive nowrap">
			  <thead>
				<tr>
					...
					<th>Jabatan Yang Dilimpahkan</th>
					<th>Rentang Tanggal Aktif</th>
					<th>Status</th>
					<th width="45">&nbsp;</th>
				</tr>
			  </thead>
...
$(document).ready(function() 
{
	...
	$('#activate').click(function () {
		...
		$.ajax({
			type: "GET",
			url: "{{ url('api/job/post') }}",
			dataType: "html",
			data: data,
			success: function(data){		
				swal({
					title: "Pelimpahan Jabatan", 
					text: "Aktivasi Pelimpahan Jabatan", 
					type: "success",
				});		
			}
		});		
