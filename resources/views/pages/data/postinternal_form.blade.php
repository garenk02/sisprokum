...
<div class="row">	
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			{{ Form::model($data, ['id'=>'form', 'route'=>!empty($data['post_id']) ? ['postinternal.update', $data['post_id']] : ['postinternal.create', null], 'action'=>'PostInternalController@save', 'class'=>'form-horizontal form-label-left']) }}
			...
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Tingkatan Struktur</label>		
				<div class="col-md-6 col-sm-6 col-xs-12">
				{{ Form::select('post_structure', $structure_options, null, ['class'=>'form-control select2_single']) }}
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Struktural Jabatan</label>		
				<div class="col-md-6 col-sm-6 col-xs-12">
				{{ Form::select('post_structural', $structural_options, null, ['class'=>'form-control select2_single']) }}
				</div>
			</div>				
			<div class="form-group">
