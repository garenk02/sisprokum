...
@endif
			...
			<div class="form-group">
				...
				<div class="col-md-10 col-sm-9 col-xs-12">
				{{ Form::select('outbox_represent', $represent_options, null, !empty($data['outbox_agenda_number']) ? ['class'=>'form-control select2_single','disabled'=>true] : ['id'=>'represent','class'=>'form-control select2_single']) }}
