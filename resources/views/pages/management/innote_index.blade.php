...
@endif
				...
				<div id="searchbox" class="panel-collapse collapse" role="tabpanel">
					...
					<div class="row form-group">
						...
						<div class="col-sm-4 col-xs-12">{{ Form::select('status', $status_options, !empty($status_selected) ? $status_selected : null, ['id'=>'status','class'=>'form-control','placeholder'=>'Pilih Status Surat']) }}</div>						
					</div>
					<div class="row form-group">
