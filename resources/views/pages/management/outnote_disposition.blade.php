...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			{{ Form::model($data, ['id'=>'form', 'route'=> !empty($data['receiver_id']) ? ['outnote.update', $data['receiver_id']] : ['outnote.create', null], 'action'=>'OutnoteController@save', 'class'=>'form-horizontal form-label-left']) }}
...
@foreach ($data['memo_corrector'] as $corrector)
						<li>{{ (sizeof($data['memo_corrector']) > 1 ? "-" : "").$corrector['name']." | ".$corrector['post']." | ".$receiver['unit'] }}</li>
@endforeach
						</ul>
						</div>
					</div>
