...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			{{ Form::model($data, ['id'=>'form', 'route'=>!empty($data['memo_id']) ? ['outmemo.update', $data['memo_id']] : ['outmemo.create', null], 'action'=>'OutmemoController@save', 'class'=>'form-horizontal form-label-left']) }}
...
$(document).ready(function()
{
	...
	$('#print').click(function() {
		var url = "{{ url('outmemo/print/'.$data['receiver_id']) }}";
		window.open(url);
	});
});
</script>
