...
@endif
				...
				<div id="searchbox" class="panel-collapse collapse" role="tabpanel">
					...
					<div class="row form-group">
						<div class="col-sm-3 col-xs-12">{{ Form::text('content', null, ['id'=>'content','class'=>'form-control','placeholder'=>'Hal']) }}</div>
					...
					<div class="row form-group">
						...
						{{ Form::select('agenda_unit', $unit_external_options, null, ['id'=>'agenda_unit','class'=>'form-control','placeholder'=>'Pilih Kode Unit']) }}
						</div>
    ...
    var oTable = $(".js-data").DataTable({
        ...
        "ajax": {
			...
			"data": function(data) {
				...
				data.agenda_unit = $('#agenda_unit').val();
        ...
        "columns": [
			...
			{ "data": "outbox_date" },
            { "data": "outbox_content" },
			{ "data": "outbox_sender_post_code" },
			{ "data": "outbox_receiver" },
			{ "data": "outbox_cc" },
			{ "data": "outbox_development" },
			{ "data": "outbox_pending" },
			{ "data": "outbox_status" },
            { "data": "editor" }
        ],
